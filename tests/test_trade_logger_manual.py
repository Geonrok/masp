...
def main() -> bool:
    ...
    test_trades = [
        {"exchange": "upbit", "order_id": f"test_{run_tag}_001", "symbol": "BTC/KRW",
         "side": "BUY", "quantity": 0.001, "price": 133000000, "fee": 665, "pnl": 0, "status": "FILLED"},
        {"exchange": "upbit", "order_id": f"test_{run_tag}_002", "symbol": "ETH/KRW",
         "side": "buy", "quantity": 0.1, "price": 4500000, "fee": 225, "pnl": 0, "status": "FILLED"},
        {"exchange": "bithumb", "order_id": f"test_{run_tag}_003", "symbol": "BTC/KRW",
         "side": "SELL", "quantity": 0.001, "price": 133500000, "fee": 668, "pnl": 500, "status": "FILLED"},
    ]
    ...
    reporter = DailyReportGenerator(trade_logger, health_monitor, report_dir=str(reports_dir))
