...
def run_portfolio_oos_fixed(all_data, strat_fn, min_oos_bars=8000,
...
def main():
    ...
    for pct in [10, 25, 50, 75, 90, 100]:
        ...
        bars = oos_dist[idx]
        print(f"  P{pct:>3}: {bars:>6} bars ({bars/24:>6.0f} days, {bars/24/30:>4.1f} months)")
    ...
    for strat_name, strat_fn in strategies.items():
        ...
        for threshold, desc in thresholds:
            ...
            for scale_name, scale in [('1x', 1.0), ('3x', 3.0), ('5x', 5.0)]:
                r = run_portfolio_oos_fixed(all_data, strat_fn,
                ...
                if r:
                    ...
                    print(f"    {scale_name}: [{p}/6] Sharpe={r['sharpe']:.2f} "
    ...
    for strat_name, strat_fn in strategies.items():
        ...
        for threshold, desc in thresholds:
            ...
            if r:
                ...
                print(f"  OOS>{threshold:>5}: [{p}/6] Sharpe={r['sharpe']:.2f} "
