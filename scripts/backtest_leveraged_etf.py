...
for name, strategy_func in strategies.items():
    try:
        ...
        if is_sharpe and oos_sharpe:
            ...
            print(f"  WF Ratio (OOS/IS): {oos_sharpe/is_sharpe:.2f}" if is_sharpe > 0 else "")
...
# Buy & Hold 대비
bh_row = results_df[results_df['strategy'] == 'Buy_Hold'].iloc[0] if 'Buy_Hold' in results_df['strategy'].values else None
